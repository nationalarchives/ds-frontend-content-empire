...
function lcLoadMenus() {
  ...
  lc_menu_0.addMenuItem("SOURCE&nbsp;ONE","location='g3cs1s1a.htm'");
  lc_menu_0.addMenuItem("SOURCE&nbsp;TWO","location='g3cs1s2a.htm'");
  lc_menu_0.addMenuItem("SOURCE&nbsp;THREE","location='g3cs1s3a.htm'");
  lc_menu_0.addMenuItem("SOURCE&nbsp;FOUR","location='g3cs1s4a.htm'");
  lc_menu_0.addMenuItem("SOURCE&nbsp;FIVE","location='g3cs1s5a.htm'");
